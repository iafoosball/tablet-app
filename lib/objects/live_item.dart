...
factory LiveItem.fromJson(Map<String, dynamic> json){
  ...
  print(json['position'].toString().length);
  return LiveItem(
tableID : json['tableID'],
started : json['started'] == null ? false : true,
users : (json['users'] as List).map((i) => User.fromJson(i)).toList(),
positions : json['position'].toString().length>3 ? Position.fromJson(json['positions']):null,
scoreRed : json['scoreRed'] == null ? 0:json['scoreRed'],
scoreBlue : json['scoreBlue']== null ? 0:json['scoreBlue'],
